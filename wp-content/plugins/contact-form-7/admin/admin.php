...
function wpcf7_admin_menu() {
	...
	$showlist = add_submenu_page( 'wpcf7',
		__( 'Show list', 'contact-form-7' ),
		__( 'Show list', 'contact-form-7' ),
		'wpcf7_edit_contact_forms', 'wpcf7-show',
		'wpcf7_admin_list_form' );

	add_action( 'load-' . $showlist, 'wpcf7_load_contact_form_admin' );
...
function wpcf7_admin_list_form() {
	global $wpdb;
	$res = $wpdb->get_results("SELECT * FROM ".$wpdb->prefix."form");
	
	require_once WPCF7_PLUGIN_DIR . '/admin/list-form.php';
